   ...
   <section class="home" id="home">
      ...
      <div class="slide-container">
         ...
         <div class="slide active">
            <div class="image">
               <img src="images/images/home-img-1.png" alt="">
            </div>
            <div class="content">
               <h3>Signature House Pizza</h3>
         ...
         <div class="slide">
            <div class="image">
               <img src="images/images/home-img-2.png" alt="">
            </div>
            <div class="content">
               <h3>House Mushroom Pizza</h3>
               <div class="fas fa-angle-left" onclick="prev()"></div>
               <div class="fas fa-angle-right" onclick="next()"></div>
            </div>
         </div>
         ...
         <div class="slide">
            <div class="image">
               <img src="images/images/home-img-3.png" alt="">
            </div>
            <div class="content">
               <h3>Mascarpone Cheesy Pizza</h3>
               <div class="fas fa-angle-left" onclick="prev()"></div>
               <div class="fas fa-angle-right" onclick="next()"></div>
            </div>
         </div>
...
<section id="menu" class="menu">
   ...
   <div class="box-container">
      ...
      <div class="box">
         <img src="images/pepperoniPizz.png" alt="">
         <p>PIZZA</p>
      </div>

      <div class="box">
         <img src="images/cheesyStick.jpg" alt="">
         <p>BREAD</p>
      </div>
      
      <div class="box">
         <img src="images/bbqChick.jpg" alt="">
         <p>CHICKEN</p>
      </div>
      
      <div class="box">
         <img src="images/drinkTropicana.jpg" alt="">
         <p>DRINKS</p>
      </div>
      
      <div class="box">
         <img src="images/chocCake.jpg" alt="">
         <p>DESSERTS</p>
      </div>

      <div class="box">
         <img src="images/onionRing.jpg" alt="">
         <p>SIDES</p>
      </div>
   </div>
   <br>
...
<section class="about-us" id="about-us" style="background-image: url('<?php echo './images/pizza4.png'; ?>'); 
   ...
   text-shadow: var(--box-shadow);">Learn More About Pizza House</h3>
...
<div class="order-now">
   ...
   <section class="box-container">
      ...
      <p>Our delivery service covers selected areas throughout 12 states in Malaysia!</p>
