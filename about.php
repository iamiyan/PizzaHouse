...
<div class="shopping-cart">
        ...
        ?>
        <div class="box">
        <a href="about.php?delete_cart_item=<?= $fetch_cart['id']; ?>" class="fas fa-times" onclick="return confirm('delete this cart item?');"></a>
...
<section class="about-us-page" id="about-us-page">
   ...
   <h3>Pizza House Story</h3>

    <div class="box-container">
    
        <div class="box">
            <p>The history of Pizza House begins in 1985 when its founder, John Smith, had a passion for pizza and dreamed of opening his own pizzeria. John had extensive experience in the restaurant industry and had worked at several pizza places, but he wanted to create a restaurant that offered something unique.

In 1986, John opened the first Pizza House in a small town in upstate New York. The restaurant was an immediate hit with the locals, who loved the fresh ingredients and unique toppings. John's commitment to quality ingredients and customer satisfaction quickly made Pizza House a household name in the region.</p>

<p>Over the years, Pizza House continued to expand, opening new locations in neighboring towns and eventually expanding to other states. The company's commitment to quality ingredients and customer service remained the same, and it quickly became one of the most popular pizza chains in the country.

In the early 2000s, Pizza House introduced online ordering, making it even easier for customers to enjoy their favorite pizzas from the comfort of their own homes. The company also began to offer delivery, which helped to increase its popularity even further.

Today, Pizza House has over 200 locations throughout the United States and continues to be a favorite among pizza lovers. The company's commitment to quality ingredients and customer satisfaction has remained steadfast, and its loyal customer base continues to grow year after year.</p>
        </div>
